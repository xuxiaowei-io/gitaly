...
// ErrorWrapAnalyzer implements an analyzer to detect unexpected error interpolation without %w.
...
func runErrorWrapAnalyzer(pass *analysis.Pass) (interface{}, error) {
