...
func (x *SystemResourceError) Reset() {
	*x = SystemResourceError{}
	if protoimpl.UnsafeEnabled {
...
func (x *SystemResourceError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SystemResourceError) ProtoMessage() {}

func (x *SystemResourceError) ProtoReflect() protoreflect.Message {
	mi := &file_errors_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SystemResourceError.ProtoReflect.Descriptor instead.
func (*SystemResourceError) Descriptor() ([]byte, []int) {
	return file_errors_proto_rawDescGZIP(), []int{4}
}

func (x *SystemResourceError) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
func (x *SystemResourceError) GetRetryable() bool {
	if x != nil {
		return x.Retryable
	}
	return false
...
var file_errors_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x58, 0x0a, 0x13, 0x53, 0x79, 0x73, 0x74, 0x65,
	0x6d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x23,
...
var file_errors_proto_goTypes = []interface{}{
	...
	(*SystemResourceError)(nil),  // 4: gitaly.SystemResourceError
}
...
func file_errors_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_errors_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SystemResourceError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
