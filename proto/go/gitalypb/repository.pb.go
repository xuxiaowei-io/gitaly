...
var file_repository_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x68, 0x32, 0xbc, 0x1f, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f,
	...
	0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x12, 0x63, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x61,
	...
	0x73, 0x65, 0x22, 0x09, 0x88, 0x02, 0x01, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x03, 0x12, 0x4e, 0x0a,
	0x0a, 0x52, 0x65, 0x70, 0x61, 0x63, 0x6b, 0x46, 0x75, 0x6c, 0x6c, 0x12, 0x19, 0x2e, 0x67, 0x69,
	...
	0x73, 0x65, 0x22, 0x09, 0x88, 0x02, 0x01, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x03, 0x12, 0x4e, 0x0a,
	0x0a, 0x4d, 0x69, 0x64, 0x78, 0x52, 0x65, 0x70, 0x61, 0x63, 0x6b, 0x12, 0x19, 0x2e, 0x67, 0x69,
	...
	0x73, 0x65, 0x22, 0x09, 0x88, 0x02, 0x01, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x03, 0x12, 0x5a, 0x0a,
	0x0e, 0x47, 0x61, 0x72, 0x62, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x12,
	0x1d, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x47, 0x61, 0x72, 0x62, 0x61, 0x67, 0x65,
	...
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x09,
	0x88, 0x02, 0x01, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x03, 0x12, 0x60, 0x0a, 0x10, 0x57, 0x72, 0x69,
	0x74, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x47, 0x72, 0x61, 0x70, 0x68, 0x12, 0x1f, 0x2e,
	0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x57, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x6d, 0x6d,
	0x69, 0x74, 0x47, 0x72, 0x61, 0x70, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20,
	...
	0x22, 0x09, 0x88, 0x02, 0x01, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x03, 0x12, 0x57, 0x0a, 0x0e, 0x52,
	...
	0x22, 0x09, 0x88, 0x02, 0x01, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x03, 0x12, 0x50, 0x0a, 0x0b, 0x47,
	...
	0x65, 0x73, 0x42, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x30, 0x01, 0x12, 0x65, 0x0a, 0x12, 0x52, 0x65,
	...
	0x01, 0x12, 0x62, 0x0a, 0x11, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x43, 0x75, 0x73, 0x74, 0x6f,
	...
	0x02, 0x01, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x01, 0x12, 0x48, 0x0a, 0x08, 0x46, 0x75, 0x6c, 0x6c,
...
var file_repository_proto_depIdxs = []int32{
	...
	92, // 9: gitaly.ObjectFormatRequest.repository:type_name -> gitaly.Repository
	93, // 10: gitaly.ObjectFormatResponse.format:type_name -> gitaly.ObjectFormat
	92, // 11: gitaly.ApplyGitattributesRequest.repository:type_name -> gitaly.Repository
	92, // 12: gitaly.FetchBundleRequest.repository:type_name -> gitaly.Repository
	92, // 13: gitaly.FetchRemoteRequest.repository:type_name -> gitaly.Repository
	74, // 14: gitaly.FetchRemoteRequest.remote_params:type_name -> gitaly.Remote
	92, // 15: gitaly.CreateRepositoryRequest.repository:type_name -> gitaly.Repository
	93, // 16: gitaly.CreateRepositoryRequest.object_format:type_name -> gitaly.ObjectFormat
	92, // 17: gitaly.GetArchiveRequest.repository:type_name -> gitaly.Repository
	1,  // 18: gitaly.GetArchiveRequest.format:type_name -> gitaly.GetArchiveRequest.Format
	92, // 19: gitaly.HasLocalBranchesRequest.repository:type_name -> gitaly.Repository
	92, // 20: gitaly.FetchSourceBranchRequest.repository:type_name -> gitaly.Repository
	92, // 21: gitaly.FetchSourceBranchRequest.source_repository:type_name -> gitaly.Repository
	92, // 22: gitaly.FsckRequest.repository:type_name -> gitaly.Repository
	92, // 23: gitaly.WriteRefRequest.repository:type_name -> gitaly.Repository
	92, // 24: gitaly.FindMergeBaseRequest.repository:type_name -> gitaly.Repository
	92, // 25: gitaly.CreateForkRequest.repository:type_name -> gitaly.Repository
	92, // 26: gitaly.CreateForkRequest.source_repository:type_name -> gitaly.Repository
	92, // 27: gitaly.CreateRepositoryFromURLRequest.repository:type_name -> gitaly.Repository
	92, // 28: gitaly.CreateBundleRequest.repository:type_name -> gitaly.Repository
	92, // 29: gitaly.CreateBundleFromRefListRequest.repository:type_name -> gitaly.Repository
	92, // 30: gitaly.GetConfigRequest.repository:type_name -> gitaly.Repository
	...
	5,  // 97: gitaly.RepositoryService.RepositoryExists:output_type -> gitaly.RepositoryExistsResponse
	7,  // 98: gitaly.RepositoryService.RepackIncremental:output_type -> gitaly.RepackIncrementalResponse
	9,  // 99: gitaly.RepositoryService.RepackFull:output_type -> gitaly.RepackFullResponse
	11, // 100: gitaly.RepositoryService.MidxRepack:output_type -> gitaly.MidxRepackResponse
	13, // 101: gitaly.RepositoryService.GarbageCollect:output_type -> gitaly.GarbageCollectResponse
	15, // 102: gitaly.RepositoryService.WriteCommitGraph:output_type -> gitaly.WriteCommitGraphResponse
	19, // 103: gitaly.RepositoryService.RepositorySize:output_type -> gitaly.RepositorySizeResponse
	21, // 104: gitaly.RepositoryService.ObjectFormat:output_type -> gitaly.ObjectFormatResponse
	23, // 105: gitaly.RepositoryService.ApplyGitattributes:output_type -> gitaly.ApplyGitattributesResponse
	27, // 106: gitaly.RepositoryService.FetchRemote:output_type -> gitaly.FetchRemoteResponse
	29, // 107: gitaly.RepositoryService.CreateRepository:output_type -> gitaly.CreateRepositoryResponse
	31, // 108: gitaly.RepositoryService.GetArchive:output_type -> gitaly.GetArchiveResponse
	33, // 109: gitaly.RepositoryService.HasLocalBranches:output_type -> gitaly.HasLocalBranchesResponse
	35, // 110: gitaly.RepositoryService.FetchSourceBranch:output_type -> gitaly.FetchSourceBranchResponse
	37, // 111: gitaly.RepositoryService.Fsck:output_type -> gitaly.FsckResponse
	39, // 112: gitaly.RepositoryService.WriteRef:output_type -> gitaly.WriteRefResponse
	41, // 113: gitaly.RepositoryService.FindMergeBase:output_type -> gitaly.FindMergeBaseResponse
	43, // 114: gitaly.RepositoryService.CreateFork:output_type -> gitaly.CreateForkResponse
	45, // 115: gitaly.RepositoryService.CreateRepositoryFromURL:output_type -> gitaly.CreateRepositoryFromURLResponse
	47, // 116: gitaly.RepositoryService.CreateBundle:output_type -> gitaly.CreateBundleResponse
	49, // 117: gitaly.RepositoryService.CreateBundleFromRefList:output_type -> gitaly.CreateBundleFromRefListResponse
	25, // 118: gitaly.RepositoryService.FetchBundle:output_type -> gitaly.FetchBundleResponse
	57, // 119: gitaly.RepositoryService.CreateRepositoryFromBundle:output_type -> gitaly.CreateRepositoryFromBundleResponse
	51, // 120: gitaly.RepositoryService.GetConfig:output_type -> gitaly.GetConfigResponse
	59, // 121: gitaly.RepositoryService.FindLicense:output_type -> gitaly.FindLicenseResponse
	61, // 122: gitaly.RepositoryService.GetInfoAttributes:output_type -> gitaly.GetInfoAttributesResponse
	63, // 123: gitaly.RepositoryService.CalculateChecksum:output_type -> gitaly.CalculateChecksumResponse
	17, // 124: gitaly.RepositoryService.Cleanup:output_type -> gitaly.CleanupResponse
	65, // 125: gitaly.RepositoryService.GetSnapshot:output_type -> gitaly.GetSnapshotResponse
	67, // 126: gitaly.RepositoryService.CreateRepositoryFromSnapshot:output_type -> gitaly.CreateRepositoryFromSnapshotResponse
	69, // 127: gitaly.RepositoryService.GetRawChanges:output_type -> gitaly.GetRawChangesResponse
	73, // 128: gitaly.RepositoryService.SearchFilesByContent:output_type -> gitaly.SearchFilesByContentResponse
	71, // 129: gitaly.RepositoryService.SearchFilesByName:output_type -> gitaly.SearchFilesByNameResponse
	53, // 130: gitaly.RepositoryService.RestoreCustomHooks:output_type -> gitaly.RestoreCustomHooksResponse
	55, // 131: gitaly.RepositoryService.BackupCustomHooks:output_type -> gitaly.BackupCustomHooksResponse
	76, // 132: gitaly.RepositoryService.GetObjectDirectorySize:output_type -> gitaly.GetObjectDirectorySizeResponse
	78, // 133: gitaly.RepositoryService.RemoveRepository:output_type -> gitaly.RemoveRepositoryResponse
	80, // 134: gitaly.RepositoryService.RenameRepository:output_type -> gitaly.RenameRepositoryResponse
	82, // 135: gitaly.RepositoryService.ReplicateRepository:output_type -> gitaly.ReplicateRepositoryResponse
	84, // 136: gitaly.RepositoryService.OptimizeRepository:output_type -> gitaly.OptimizeRepositoryResponse
	86, // 137: gitaly.RepositoryService.PruneUnreachableObjects:output_type -> gitaly.PruneUnreachableObjectsResponse
	88, // 138: gitaly.RepositoryService.SetFullPath:output_type -> gitaly.SetFullPathResponse
	90, // 139: gitaly.RepositoryService.FullPath:output_type -> gitaly.FullPathResponse
