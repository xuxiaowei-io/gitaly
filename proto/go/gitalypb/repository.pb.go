...
var file_repository_proto_rawDesc = []byte{
	...
	0xdd, 0x01, 0x0a, 0x19, 0x4f, 0x70, 0x74, 0x69, 0x6d, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x70, 0x6f,
	...
	0x3e, 0x0a, 0x08, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x12, 0x18, 0x0a, 0x14, 0x53,
	...
	0x59, 0x5f, 0x48, 0x45, 0x55, 0x52, 0x49, 0x53, 0x54, 0x49, 0x43, 0x41, 0x4c, 0x10, 0x01, 0x22,
...
var file_repository_proto_depIdxs = []int32{
	...
	90, // 14: gitaly.GetArchiveRequest.repository:type_name -> gitaly.Repository
	1,  // 15: gitaly.GetArchiveRequest.format:type_name -> gitaly.GetArchiveRequest.Format
	90, // 16: gitaly.HasLocalBranchesRequest.repository:type_name -> gitaly.Repository
	90, // 17: gitaly.FetchSourceBranchRequest.repository:type_name -> gitaly.Repository
	90, // 18: gitaly.FetchSourceBranchRequest.source_repository:type_name -> gitaly.Repository
	90, // 19: gitaly.FsckRequest.repository:type_name -> gitaly.Repository
	90, // 20: gitaly.WriteRefRequest.repository:type_name -> gitaly.Repository
	90, // 21: gitaly.FindMergeBaseRequest.repository:type_name -> gitaly.Repository
	90, // 22: gitaly.CreateForkRequest.repository:type_name -> gitaly.Repository
	90, // 23: gitaly.CreateForkRequest.source_repository:type_name -> gitaly.Repository
	...
	90, // 29: gitaly.BackupCustomHooksRequest.repository:type_name -> gitaly.Repository
	90, // 30: gitaly.CreateRepositoryFromBundleRequest.repository:type_name -> gitaly.Repository
	90, // 31: gitaly.FindLicenseRequest.repository:type_name -> gitaly.Repository
	90, // 32: gitaly.GetInfoAttributesRequest.repository:type_name -> gitaly.Repository
	90, // 33: gitaly.CalculateChecksumRequest.repository:type_name -> gitaly.Repository
	90, // 34: gitaly.GetSnapshotRequest.repository:type_name -> gitaly.Repository
	90, // 35: gitaly.CreateRepositoryFromSnapshotRequest.repository:type_name -> gitaly.Repository
	90, // 36: gitaly.GetRawChangesRequest.repository:type_name -> gitaly.Repository
	89, // 37: gitaly.GetRawChangesResponse.raw_changes:type_name -> gitaly.GetRawChangesResponse.RawChange
	90, // 38: gitaly.SearchFilesByNameRequest.repository:type_name -> gitaly.Repository
	90, // 39: gitaly.SearchFilesByContentRequest.repository:type_name -> gitaly.Repository
	90, // 40: gitaly.GetObjectDirectorySizeRequest.repository:type_name -> gitaly.Repository
	90, // 41: gitaly.RemoveRepositoryRequest.repository:type_name -> gitaly.Repository
	90, // 42: gitaly.RenameRepositoryRequest.repository:type_name -> gitaly.Repository
	90, // 43: gitaly.ReplicateRepositoryRequest.repository:type_name -> gitaly.Repository
	90, // 44: gitaly.ReplicateRepositoryRequest.source:type_name -> gitaly.Repository
	90, // 45: gitaly.OptimizeRepositoryRequest.repository:type_name -> gitaly.Repository
	3,  // 46: gitaly.OptimizeRepositoryRequest.strategy:type_name -> gitaly.OptimizeRepositoryRequest.Strategy
	90, // 47: gitaly.PruneUnreachableObjectsRequest.repository:type_name -> gitaly.Repository
	90, // 48: gitaly.SetFullPathRequest.repository:type_name -> gitaly.Repository
	90, // 49: gitaly.FullPathRequest.repository:type_name -> gitaly.Repository
	2,  // 50: gitaly.GetRawChangesResponse.RawChange.operation:type_name -> gitaly.GetRawChangesResponse.RawChange.Operation
	4,  // 51: gitaly.RepositoryService.RepositoryExists:input_type -> gitaly.RepositoryExistsRequest
	6,  // 52: gitaly.RepositoryService.RepackIncremental:input_type -> gitaly.RepackIncrementalRequest
	8,  // 53: gitaly.RepositoryService.RepackFull:input_type -> gitaly.RepackFullRequest
	10, // 54: gitaly.RepositoryService.MidxRepack:input_type -> gitaly.MidxRepackRequest
	12, // 55: gitaly.RepositoryService.GarbageCollect:input_type -> gitaly.GarbageCollectRequest
	14, // 56: gitaly.RepositoryService.WriteCommitGraph:input_type -> gitaly.WriteCommitGraphRequest
	18, // 57: gitaly.RepositoryService.RepositorySize:input_type -> gitaly.RepositorySizeRequest
	20, // 58: gitaly.RepositoryService.ApplyGitattributes:input_type -> gitaly.ApplyGitattributesRequest
	24, // 59: gitaly.RepositoryService.FetchRemote:input_type -> gitaly.FetchRemoteRequest
	26, // 60: gitaly.RepositoryService.CreateRepository:input_type -> gitaly.CreateRepositoryRequest
	28, // 61: gitaly.RepositoryService.GetArchive:input_type -> gitaly.GetArchiveRequest
	30, // 62: gitaly.RepositoryService.HasLocalBranches:input_type -> gitaly.HasLocalBranchesRequest
	32, // 63: gitaly.RepositoryService.FetchSourceBranch:input_type -> gitaly.FetchSourceBranchRequest
	34, // 64: gitaly.RepositoryService.Fsck:input_type -> gitaly.FsckRequest
	36, // 65: gitaly.RepositoryService.WriteRef:input_type -> gitaly.WriteRefRequest
	38, // 66: gitaly.RepositoryService.FindMergeBase:input_type -> gitaly.FindMergeBaseRequest
	40, // 67: gitaly.RepositoryService.CreateFork:input_type -> gitaly.CreateForkRequest
	42, // 68: gitaly.RepositoryService.CreateRepositoryFromURL:input_type -> gitaly.CreateRepositoryFromURLRequest
	44, // 69: gitaly.RepositoryService.CreateBundle:input_type -> gitaly.CreateBundleRequest
	46, // 70: gitaly.RepositoryService.CreateBundleFromRefList:input_type -> gitaly.CreateBundleFromRefListRequest
	22, // 71: gitaly.RepositoryService.FetchBundle:input_type -> gitaly.FetchBundleRequest
	54, // 72: gitaly.RepositoryService.CreateRepositoryFromBundle:input_type -> gitaly.CreateRepositoryFromBundleRequest
	48, // 73: gitaly.RepositoryService.GetConfig:input_type -> gitaly.GetConfigRequest
	56, // 74: gitaly.RepositoryService.FindLicense:input_type -> gitaly.FindLicenseRequest
	58, // 75: gitaly.RepositoryService.GetInfoAttributes:input_type -> gitaly.GetInfoAttributesRequest
	60, // 76: gitaly.RepositoryService.CalculateChecksum:input_type -> gitaly.CalculateChecksumRequest
	16, // 77: gitaly.RepositoryService.Cleanup:input_type -> gitaly.CleanupRequest
	62, // 78: gitaly.RepositoryService.GetSnapshot:input_type -> gitaly.GetSnapshotRequest
	64, // 79: gitaly.RepositoryService.CreateRepositoryFromSnapshot:input_type -> gitaly.CreateRepositoryFromSnapshotRequest
	66, // 80: gitaly.RepositoryService.GetRawChanges:input_type -> gitaly.GetRawChangesRequest
	70, // 81: gitaly.RepositoryService.SearchFilesByContent:input_type -> gitaly.SearchFilesByContentRequest
	68, // 82: gitaly.RepositoryService.SearchFilesByName:input_type -> gitaly.SearchFilesByNameRequest
	50, // 83: gitaly.RepositoryService.RestoreCustomHooks:input_type -> gitaly.RestoreCustomHooksRequest
	52, // 84: gitaly.RepositoryService.BackupCustomHooks:input_type -> gitaly.BackupCustomHooksRequest
	73, // 85: gitaly.RepositoryService.GetObjectDirectorySize:input_type -> gitaly.GetObjectDirectorySizeRequest
	75, // 86: gitaly.RepositoryService.RemoveRepository:input_type -> gitaly.RemoveRepositoryRequest
	77, // 87: gitaly.RepositoryService.RenameRepository:input_type -> gitaly.RenameRepositoryRequest
	79, // 88: gitaly.RepositoryService.ReplicateRepository:input_type -> gitaly.ReplicateRepositoryRequest
	81, // 89: gitaly.RepositoryService.OptimizeRepository:input_type -> gitaly.OptimizeRepositoryRequest
	83, // 90: gitaly.RepositoryService.PruneUnreachableObjects:input_type -> gitaly.PruneUnreachableObjectsRequest
	85, // 91: gitaly.RepositoryService.SetFullPath:input_type -> gitaly.SetFullPathRequest
	87, // 92: gitaly.RepositoryService.FullPath:input_type -> gitaly.FullPathRequest
	5,  // 93: gitaly.RepositoryService.RepositoryExists:output_type -> gitaly.RepositoryExistsResponse
	7,  // 94: gitaly.RepositoryService.RepackIncremental:output_type -> gitaly.RepackIncrementalResponse
	9,  // 95: gitaly.RepositoryService.RepackFull:output_type -> gitaly.RepackFullResponse
	11, // 96: gitaly.RepositoryService.MidxRepack:output_type -> gitaly.MidxRepackResponse
	13, // 97: gitaly.RepositoryService.GarbageCollect:output_type -> gitaly.GarbageCollectResponse
	15, // 98: gitaly.RepositoryService.WriteCommitGraph:output_type -> gitaly.WriteCommitGraphResponse
	19, // 99: gitaly.RepositoryService.RepositorySize:output_type -> gitaly.RepositorySizeResponse
	21, // 100: gitaly.RepositoryService.ApplyGitattributes:output_type -> gitaly.ApplyGitattributesResponse
	25, // 101: gitaly.RepositoryService.FetchRemote:output_type -> gitaly.FetchRemoteResponse
	27, // 102: gitaly.RepositoryService.CreateRepository:output_type -> gitaly.CreateRepositoryResponse
	29, // 103: gitaly.RepositoryService.GetArchive:output_type -> gitaly.GetArchiveResponse
	31, // 104: gitaly.RepositoryService.HasLocalBranches:output_type -> gitaly.HasLocalBranchesResponse
	33, // 105: gitaly.RepositoryService.FetchSourceBranch:output_type -> gitaly.FetchSourceBranchResponse
	35, // 106: gitaly.RepositoryService.Fsck:output_type -> gitaly.FsckResponse
	37, // 107: gitaly.RepositoryService.WriteRef:output_type -> gitaly.WriteRefResponse
	39, // 108: gitaly.RepositoryService.FindMergeBase:output_type -> gitaly.FindMergeBaseResponse
	41, // 109: gitaly.RepositoryService.CreateFork:output_type -> gitaly.CreateForkResponse
	43, // 110: gitaly.RepositoryService.CreateRepositoryFromURL:output_type -> gitaly.CreateRepositoryFromURLResponse
	45, // 111: gitaly.RepositoryService.CreateBundle:output_type -> gitaly.CreateBundleResponse
	47, // 112: gitaly.RepositoryService.CreateBundleFromRefList:output_type -> gitaly.CreateBundleFromRefListResponse
	23, // 113: gitaly.RepositoryService.FetchBundle:output_type -> gitaly.FetchBundleResponse
	55, // 114: gitaly.RepositoryService.CreateRepositoryFromBundle:output_type -> gitaly.CreateRepositoryFromBundleResponse
	49, // 115: gitaly.RepositoryService.GetConfig:output_type -> gitaly.GetConfigResponse
	57, // 116: gitaly.RepositoryService.FindLicense:output_type -> gitaly.FindLicenseResponse
	59, // 117: gitaly.RepositoryService.GetInfoAttributes:output_type -> gitaly.GetInfoAttributesResponse
	61, // 118: gitaly.RepositoryService.CalculateChecksum:output_type -> gitaly.CalculateChecksumResponse
	17, // 119: gitaly.RepositoryService.Cleanup:output_type -> gitaly.CleanupResponse
	63, // 120: gitaly.RepositoryService.GetSnapshot:output_type -> gitaly.GetSnapshotResponse
	65, // 121: gitaly.RepositoryService.CreateRepositoryFromSnapshot:output_type -> gitaly.CreateRepositoryFromSnapshotResponse
	67, // 122: gitaly.RepositoryService.GetRawChanges:output_type -> gitaly.GetRawChangesResponse
	71, // 123: gitaly.RepositoryService.SearchFilesByContent:output_type -> gitaly.SearchFilesByContentResponse
	69, // 124: gitaly.RepositoryService.SearchFilesByName:output_type -> gitaly.SearchFilesByNameResponse
	51, // 125: gitaly.RepositoryService.RestoreCustomHooks:output_type -> gitaly.RestoreCustomHooksResponse
	53, // 126: gitaly.RepositoryService.BackupCustomHooks:output_type -> gitaly.BackupCustomHooksResponse
	74, // 127: gitaly.RepositoryService.GetObjectDirectorySize:output_type -> gitaly.GetObjectDirectorySizeResponse
	76, // 128: gitaly.RepositoryService.RemoveRepository:output_type -> gitaly.RemoveRepositoryResponse
	78, // 129: gitaly.RepositoryService.RenameRepository:output_type -> gitaly.RenameRepositoryResponse
	80, // 130: gitaly.RepositoryService.ReplicateRepository:output_type -> gitaly.ReplicateRepositoryResponse
	82, // 131: gitaly.RepositoryService.OptimizeRepository:output_type -> gitaly.OptimizeRepositoryResponse
	84, // 132: gitaly.RepositoryService.PruneUnreachableObjects:output_type -> gitaly.PruneUnreachableObjectsResponse
	86, // 133: gitaly.RepositoryService.SetFullPath:output_type -> gitaly.SetFullPathResponse
	88, // 134: gitaly.RepositoryService.FullPath:output_type -> gitaly.FullPathResponse
