	...
	t.Run("old format", func(t *testing.T) {
		testCases := []testCase{
			...
			},
			{
				...
				validateErr: errors.New("cgroups.repositories.count: must be greater than zero"),
			},
		}
	...
	t.Run("new format", func(t *testing.T) {
		testCases := []testCase{
			...
			},
			{
				...
				validateErr: errors.New("cgroups.git.count: must be greater than zero"),
			},
		}
		for _, tt := range testCases {
			t.Run(tt.name, func(t *testing.T) {
