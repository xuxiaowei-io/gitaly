	...
	testCases := []struct {
		...
		},
		{
			...
			expectedErr: testhelper.GitalyOrPraefect(
				structerr.NewInvalidArgument(`invalid git directory: GetStorageByName: no such storage: "fake"`),
		...
		},
		{
			...
			expectedErr: status.Error(codes.InvalidArgument, "tag name is empty"),
		},
	}
