...
func TestCommitDiff_collapseGenerated(t *testing.T) {
	...
	leftCommit := gittest.WriteCommit(t, cfg, repoPath,
		gittest.WithTreeEntries(
			...
			gittest.TreeEntry{Path: "abc.txt", Mode: "100644", Content: "detect me by .gitattributes\n"},
			gittest.TreeEntry{Path: "abc.go", Mode: "100644", Content: "Code generated by\n\n"},
			gittest.TreeEntry{Path: "abc.nib", Mode: "100644", Content: "detect me by extension\n"},
			gittest.TreeEntry{Path: "Gopkg.lock", Mode: "100644", Content: "detect me by filename\n"},
			gittest.TreeEntry{Path: "package-lock.json", Mode: "100644", Content: "detect me by filename, but don't treat me as generated\n"},
		))
