...
func TestFailedDiffStatsRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			leftCommitID:  "",
			rightCommitID: "8a0f2ee90d940bfb0ba1e14e8214b0649056e4ab",
			expErr:        status.Error(codes.InvalidArgument, "DiffStats: empty LeftCommitId"),
		},
		{
			...
			leftCommitID:  "e4003da16c1c2c3fc4567700121b17bf8e591c6c",
			rightCommitID: "",
			expErr:        status.Error(codes.InvalidArgument, "DiffStats: empty RightCommitId"),
		},
		{
			...
			rightCommitID: "8a0f2ee90d940bfb0ba1e14e8214b0649056e4ab",
			expErr:        status.Error(codes.Unavailable, "DiffStats: exit status 128"),
		},
		{
