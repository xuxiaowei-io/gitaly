...
func TestSearchFilesByContentLargeFile(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.filename, func(t *testing.T) {
			localrepo.WriteTestCommit(t, localrepo.NewTestRepo(t, cfg, repoProto), localrepo.WithTreeEntries(localrepo.TreeEntry{
				Path:    tc.filename,
				Mode:    "100644",
...
func TestSearchFilesByNameUnusualFileNamesSuccessful(t *testing.T) {
	...
	localrepo.WriteTestCommit(t, localrepo.NewTestRepo(t, cfg, repoProto),
		...
		localrepo.WithTreeEntries(
			localrepo.TreeEntry{Path: "\"file with quote.txt", Mode: "100644", Content: "something"},
			localrepo.TreeEntry{Path: ".vimrc", Mode: "100644", Content: "something"},
			localrepo.TreeEntry{Path: "cuộc đời là những chuyến đi.md", Mode: "100644", Content: "something"},
			localrepo.TreeEntry{Path: "编码 'foo'.md", Mode: "100644", Content: "something"},
		),
	)
...
func TestSearchFilesByNamePaginationSuccessful(t *testing.T) {
	...
	localrepo.WriteTestCommit(t, localrepo.NewTestRepo(t, cfg, repoProto),
		...
		localrepo.WithMessage("commit message"),
		localrepo.WithTreeEntries(
			localrepo.TreeEntry{Path: "file1.md", Mode: "100644", Content: "file1"},
			localrepo.TreeEntry{Path: "file2.md", Mode: "100644", Content: "file2"},
			localrepo.TreeEntry{Path: "file3.md", Mode: "100644", Content: "file3"},
			localrepo.TreeEntry{Path: "file4.md", Mode: "100644", Content: "file4"},
			localrepo.TreeEntry{Path: "file5.md", Mode: "100644", Content: "file5"},
			localrepo.TreeEntry{Path: "new_file1.md", Mode: "100644", Content: "new_file1"},
			localrepo.TreeEntry{Path: "new_file2.md", Mode: "100644", Content: "new_file2"},
			localrepo.TreeEntry{Path: "new_file3.md", Mode: "100644", Content: "new_file3"},
		),
	)
