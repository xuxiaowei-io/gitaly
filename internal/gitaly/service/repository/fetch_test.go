...
func TestFetchSourceBranch_validate(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expErr: status.Error(codes.InvalidArgument, "revision can't contain whitespace"),
		},
		{
		...
		},
		{
			...
			expErr: status.Error(codes.InvalidArgument, "revision can't contain ':'"),
		},
		{
			...
			expErr: status.Error(codes.InvalidArgument, "revision can't contain NUL"),
		},
		{
