...
func TestObjectReader_reader(t *testing.T) {
	t.Parallel()
	testhelper.NewFeatureSets(featureflag.GitV238).Run(t, testObjectReaderReader)
}

func testObjectReaderReader(t *testing.T, ctx context.Context) {
	t.Parallel()
	...
	if !version.IsCatfileBatchCommandSupported() {
		t.Skip()
	}
...
func TestObjectReader_object(t *testing.T) {
	t.Parallel()
	testhelper.NewFeatureSets(featureflag.GitV238).Run(t, testObjectReaderObject)
}
...
func TestObjectReader_queue(t *testing.T) {
	t.Parallel()
	testhelper.NewFeatureSets(featureflag.GitV238).Run(t, testObjectReaderQueue)
}

func testObjectReaderQueue(t *testing.T, ctx context.Context) {
	t.Parallel()
