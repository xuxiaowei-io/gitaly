...
func TestParser(t *testing.T) {
	...
	gitignoreBlobID := repo.MustWriteBlob(t, "gitignore")
	gitmodulesBlobID := repo.MustWriteBlob(t, "gitmodules")
...
func TestParserReadEntryPath(t *testing.T) {
	...
	regularEntriesTreeID := gittest.WriteTree(t, cfg, repoPath, []gittest.TreeEntry{
		{Path: ".gitignore", Mode: "100644", OID: repo.MustWriteBlob(t, "gitignore")},
		{Path: ".gitmodules", Mode: "100644", OID: repo.MustWriteBlob(t, "gitmodules")},
		{Path: "entry with space", Mode: "040000", OID: gittest.DefaultObjectHash.EmptyTreeOID},
		{Path: "gitlab-shell", Mode: "160000", OID: gittest.WriteCommit(t, cfg, repoPath)},
		{Path: "\"file with quote.txt", Mode: "100644", OID: repo.MustWriteBlob(t, "file with quotes")},
		{Path: "cuộc đời là những chuyến đi.md", Mode: "100644", OID: repo.MustWriteBlob(t, "file with non-ascii file name")},
		{Path: "编码 'foo'.md", Mode: "100644", OID: repo.MustWriteBlob(t, "file with non-ascii file name")},
	})
