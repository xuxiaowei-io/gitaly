...
import (
	...
	"gitlab.com/gitlab-org/gitaly/internal/command/commandcounter"
...
func mustHaveNoGoroutines() {
	if err := goleak.Find(
		...
		goleak.IgnoreTopFunction("gitlab.com/gitlab-org/gitaly/internal/gitaly/rubyserver/balancer.(*builder).monitor"),
		...
		goleak.IgnoreTopFunction("gitlab.com/gitlab-org/gitaly/internal/backchannel.clientHandshake.serve.func4"),
	); err != nil {
